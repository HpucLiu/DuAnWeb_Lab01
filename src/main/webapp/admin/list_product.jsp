...
<div class="container">
    ...
    <table class="table table-bordered table-striped">
        ...
        <tr>
            ...
            <td><%=x.getMaloai() %></td>
            <td>
                <a href="ManageProduct?action=UPDATE" class="btn btn-secondary"> <i class="bi bi-pencil-square"></i> Sửa</a>
                <a href="ManageProduct?action=DELETE" class="btn btn-danger"> <i class="bi bi-trash"></i> Xoá</a>
            </td>
            <%
                }
            %>
